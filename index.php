    ...
    <h1>Domande frequenti</h1>
        <?php
            $faq = [
                ...
                [
                    ...
                    'answer' => [
                        ...
                        'ol' => [
                            "La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera. Google LLC, con sede negli Stati Uniti, per il resto del mondo.",
            ...
            foreach ($faq as $item) {
                ...
                foreach ($item['answer'] as $key => $paragraph) {
                    ...
                    if($key === 'subTitle') {
                        ...
                        echo "<ol>";
                        foreach ($paragraph as $subParagraph) {
                            echo "<li>" . $subParagraph . "</li>";
                        }
                        echo "</ol>";
